 ...
 * generated in the com.example.demosoapclient.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _SellProductResponse_QNAME = new QName("http://service.demoservicesoap.example.com/", "sellProductResponse");
    private final static QName _AddProductResponse_QNAME = new QName("http://service.demoservicesoap.example.com/", "addProductResponse");
    private final static QName _GetAllProductsResponse_QNAME = new QName("http://service.demoservicesoap.example.com/", "getAllProductsResponse");
    private final static QName _GetAllProducts_QNAME = new QName("http://service.demoservicesoap.example.com/", "getAllProducts");
    private final static QName _AddProduct_QNAME = new QName("http://service.demoservicesoap.example.com/", "addProduct");
    private final static QName _SellProduct_QNAME = new QName("http://service.demoservicesoap.example.com/", "sellProduct");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.demosoapclient.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "sellProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "addProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "getAllProductsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "getAllProducts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "addProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demoservicesoap.example.com/", name = "sellProduct")
